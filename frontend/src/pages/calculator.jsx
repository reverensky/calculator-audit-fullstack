...
export default function Calculator() {
  const [{ result, expression, operation }, dispatch] = useReducer(reducer, {});
  ...
  return (
    <>
      ...
      >
        <Card
          id="calculator-card"
          className="max-w-[320px] max-h-[550px] w-full h-full"
        >
          <ToggleThemeButton theme={theme} toggleTheme={toggleTheme} />
          <div
            id="calculator-expression"
            className="text-right min-h-[40px] text-gray-400 w-full flex-1 align-text-bottom flex items-end justify-end"
            style={{
